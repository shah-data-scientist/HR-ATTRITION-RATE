...
try:
    ...
    with open("streamlit_simulation_payload.json", "w") as f:
        json.dump(payload, f, indent=2)
    print("[OK] Payload saved to streamlit_simulation_payload.json")
    ...
    if response.status_code == 200:
        ...
        # Save response
        with open("streamlit_simulation_response.json", "w") as f:
        ...
        with open("streamlit_simulation_error.json", "w") as f:
            json.dump(error_detail, f, indent=2)
        print("[ERROR] Error details saved to streamlit_simulation_error.json")
