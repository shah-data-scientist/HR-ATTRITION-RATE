...
class TestCliModelInitialization:
    ...
    def test_init_model_for_cli_xtrain_not_found(self, mock_read_parquet, mock_load, mock_exists):
        ...
        with patch('api.app.main.model', None):
            with patch('api.app.main.explainer', None):
                with patch('api.app.main.get_expected_columns_from_pipeline', return_value=['col1', 'col2']):
...
class TestExcelGenerationErrors:
    ...
    def test_predict_excel_with_missing_required_fields(self, client):
        ...
        payload = {
            "eval_data": [{"id_employee": 1, "age": 30}],  # Missing many required fields
